...
internal object AttrsParse {
    fun parseAmountViewAttrs(context: Context, attrs: AttributeSet?, defStyleAttr: Int): Attrs {
        ...
        val btnTextSize =
            array.getDimensionPixelSize(R.styleable.AmountView_btn_size, HiDisplayUtils.sp2px(14f))
        val btnTextColor = array.getColorStateList(R.styleable.AmountView_btn_color)
        val btnSize =
            array.getDimensionPixelSize(R.styleable.AmountView_btn_size, HiDisplayUtils.dip2px(20f))
